...
try {
    ...
    $stmt = $pdo->query("
        SELECT id, title, speaker, description, image_path, announcement_date
        ...
        <div class="glass-section">
            ...
            <div class="lectures-grid" id="lecturesContainer">
                ...
                foreach ($upcomingLectures as $lecture):
                    ...
                    $dateTimeStart = new DateTime($announcementDate . ' ' . $defaultTime);
...
<div class="modal-overlay" id="lectureModal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
            <h3 id="modalTitle">Editar Palestra</h3>
            <button class="close-btn" onclick="closeLectureModal()">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <form class="lecture-form" id="lectureForm" enctype="multipart/form-data">
            <input type="hidden" id="lectureId" name="lectureId">
            
            <div class="form-group">
                <label for="lectureImage">Imagem da Palestra (16:9)</label>
                <input type="file" id="lectureImage" name="lectureImage" accept="image/*">
                <small>Formatos aceitos: JPG, PNG. Proporção recomendada: 16:9</small>
            </div>
            ...
            <div class="form-group">
                <label for="lectureSummary">Resumo da Palestra</label>
                <textarea id="lectureSummary" name="lectureSummary" rows="4" required></textarea>
            </div>
            
            <div class="form-actions">
                <button type="button" class="btn-cancel" onclick="closeLectureModal()">Cancelar</button>
...
function populateLectureForm(lectureData) {
    ...
    document.getElementById('lectureDate').value = lectureData.announcement_date || lectureData.lecture_date || ''; // Compatibilidade com campo
