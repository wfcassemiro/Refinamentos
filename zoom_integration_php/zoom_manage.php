...
// Verificar se é administrador (ajustar conforme seu sistema de autenticação)
function isAdmin() {
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div style="margin-top: 30px; padding-top: 30px; border-top: 2px solid #e2e8f0;">
                    <h3 style="color: #4a5568; font-size: 16px; margin-bottom: 15px;">💡 Como encontrar o ID da reunião?</h3>
